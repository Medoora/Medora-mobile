...
import { Alert, Animated, Dimensions, Image, Platform, StatusBar, Switch, Text, TouchableOpacity, View } from 'react-native';
        ...
        <SafeAreaView edges={['top', 'left', 'right']} className="bg-black">
          <View className="flex-row items-center justify-between px-4 pb-2">
            ...
            {currentTab === 'Dashboard' ? (
              <TouchableOpacity onPress={() => console.log('AI Assistant')} className="w-10 h-10 items-center justify-center">
          ...
          <View className="px-4 py-2 flex-1">
            ...
            >
              ...
              <View className="ml-3 flex-1">
                <Text className="text-white font-semibold">{user?.email?.split('@')[0] || 'User'}</Text>
            ...
            <View className="mb-6">
              ...
              <TouchableOpacity 
                onPress={() => handleNavigation('/(dashboard)/dashboard/(tabs)/mydrive')}
                className="flex-row items-center px-4 py-3 rounded-xl mb-2"
              >
                <Ionicons name="folder-outline" size={20} color="#737373" />
                <Text className="text-neutral-300 ml-3">My Drive</Text>
              </TouchableOpacity>
              
              <TouchableOpacity 
                onPress={() => handleNavigation('/(dashboard)/dashboard/(tabs)/reminder')}
                className="flex-row items-center px-4 py-3 rounded-xl mb-2"
              >
                <Ionicons name="alarm-outline" size={20} color="#737373" />
                <Text className="text-neutral-300 ml-3">Reminders</Text>
              </TouchableOpacity>
            </View>
            ...
            <View className="mb-6">
              ...
              <TouchableOpacity 
                onPress={() => handleNavigation('/(dashboard)/dashboard/(tabs)/settings')}
                className="flex-row items-center px-4 py-3 rounded-xl mb-2"
              >
